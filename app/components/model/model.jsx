...
const Device = ({
  ...
  useEffect(() => {
    ...
    const load = async () => {
      ...
      // Add blinking light for microcontroller
      if (model.url.includes('chips.glb')) {
        const pointLight = new PointLight(0x00ff00, 5, 2);
        pointLight.position.set(0.05, 0.05, 0.05);
        ...
        playAnimation = (originalPlayAnimation => () => {
          const animation = originalPlayAnimation?.();
          blink();
          return animation;
        })(playAnimation);
      }
